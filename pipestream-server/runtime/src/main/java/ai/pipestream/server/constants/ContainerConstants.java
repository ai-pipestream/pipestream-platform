...
public final class ContainerConstants {
    ...
    public static final class WireMock {
        ...
        public static final String DEFAULT_IMAGE = "ghcr.io/ai-pipestream/pipestream-wiremock-server:0.1.36";
        public static final String DEFAULT_DOCKER_IO_IMAGE = "docker.io/pipestreamai/pipestream-wiremock-server:0.1.36";
